...
public class EmailSender {
    ...
    public static void sendWelcomeEmail(String toEmail) {
        ...
        properties.put("tn.esprit.pitest11.mail.smtp.host", host);
        properties.put("tn.esprit.pitest11.mail.smtp.port", port);
        properties.put("tn.esprit.pitest11.mail.smtp.auth", "true");
        properties.put("tn.esprit.pitest11.mail.smtp.starttls.enable", "true"); // Activation de TLS
