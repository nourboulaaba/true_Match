package tn.esprit.pitest11.mail;
...
public class EmailSender {
    ...
    public static void sendEmail(String recipient, String subject, String messageText) {
        ...
        props.put("tn.esprit.pitest11.mail.smtp.auth", "true");
        props.put("tn.esprit.pitest11.mail.smtp.starttls.enable", "true");
        props.put("tn.esprit.pitest11.mail.smtp.host", "smtp.gmail.com");
        props.put("tn.esprit.pitest11.mail.smtp.port", "587");
