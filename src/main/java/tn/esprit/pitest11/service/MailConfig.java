...
public class MailConfig {
    ...
    public static final String HR_EMAIL = "rhtruematch@gmail.com";       // Email du tn.esprit.pitest11.service RH
    ...
    static {
        ...
        if (HR_EMAIL == null || HR_EMAIL.isEmpty()) {
            throw new IllegalStateException("L'adresse email du tn.esprit.pitest11.service RH est manquante !");
        }
    }
