...
import tn.esprit.pitest11.utils.Constants;
...
public class MailService {
    ...
    public static void send(String recipientEmail, String generatedCode) throws MessagingException {
        // Set up tn.esprit.pitest11.mail server properties
        Properties properties = new Properties();
        properties.put("tn.esprit.pitest11.mail.smtp.host", "smtp.gmail.com");
        properties.put("tn.esprit.pitest11.mail.smtp.port", "587");
        properties.put("tn.esprit.pitest11.mail.smtp.ssl.trust", "smtp.gmail.com");
        properties.put("tn.esprit.pitest11.mail.smtp.auth", "true");
        properties.put("tn.esprit.pitest11.mail.smtp.starttls.enable", "true");
        properties.setProperty("tn.esprit.pitest11.mail.smtp.ssl.protocols", "TLSv1.2");
    ...
    public static void sendLeaveRequestNotification(String employeeName, String leaveType, String startDate, String endDate) {
        try {
            Properties properties = new Properties();
            properties.put("tn.esprit.pitest11.mail.smtp.host", MailConfig.SMTP_HOST);
            properties.put("tn.esprit.pitest11.mail.smtp.port", MailConfig.SMTP_PORT);
            properties.put("tn.esprit.pitest11.mail.smtp.auth", "true");
            properties.put("tn.esprit.pitest11.mail.smtp.starttls.enable", "true");
